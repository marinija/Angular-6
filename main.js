...
/* harmony import */ var _posts_details_posts_details_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./posts-details/posts-details.component */ "./src/app/posts-details/posts-details.component.ts");
/* harmony import */ var _image_gallery_image_gallery_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./image-gallery/image-gallery.component */ "./src/app/image-gallery/image-gallery.component.ts");
...
var routes = [
    ...
    {
        path: 'posts/:id',
        component: _posts_details_posts_details_component__WEBPACK_IMPORTED_MODULE_5__["PostsDetailsComponent"]
    },
    {
        path: 'images',
...
/* harmony import */ var _posts_details_posts_details_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./posts-details/posts-details.component */ "./src/app/posts-details/posts-details.component.ts");
/* harmony import */ var _image_gallery_image_gallery_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./image-gallery/image-gallery.component */ "./src/app/image-gallery/image-gallery.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _posts_details_posts_details_component__WEBPACK_IMPORTED_MODULE_9__["PostsDetailsComponent"],
...
module.exports = "<div class=\"galery\">\n  <ul *ngFor=\"let image of images | slice:0:20\">\n    <li>\n      <img src=\"{{image.thumbnailUrl}}\" alt=\"picture\">\n    </li>\n  </ul>\n</div>"

/***/ }),

/***/ "./src/app/image-gallery/image-gallery.component.scss":
/*!************************************************************!*\
  !*** ./src/app/image-gallery/image-gallery.component.scss ***!
  \************************************************************/
/*! no static exports found */
...
var ImageGalleryComponent = /** @class */ (function () {
    function ImageGalleryComponent(dataService) {
        this.dataService = dataService;
    }
    ImageGalleryComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.dataService.getImages().subscribe(function (data) { return _this.images = data; });
    };
    ImageGalleryComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-image-gallery',
            template: __webpack_require__(/*! ./image-gallery.component.html */ "./src/app/image-gallery/image-gallery.component.html"),
            styles: [__webpack_require__(/*! ./image-gallery.component.scss */ "./src/app/image-gallery/image-gallery.component.scss")]
        }),
...
/***/ "./src/app/posts-details/posts-details.component.html":
/*!************************************************************!*\
  !*** ./src/app/posts-details/posts-details.component.html ***!
  \************************************************************/
/*! no static exports found */
...
module.exports = "<ul>\n  <li>\n    <strong>Title:</strong> {{ post.title }}</li>\n  <li>\n    <strong>Body:</strong> {{ post.body }}</li>\n</ul>"

/***/ }),

/***/ "./src/app/posts-details/posts-details.component.scss":
/*!************************************************************!*\
  !*** ./src/app/posts-details/posts-details.component.scss ***!
  \************************************************************/
/*! no static exports found */
...
/***/ "./src/app/posts-details/posts-details.component.ts":
/*!**********************************************************!*\
  !*** ./src/app/posts-details/posts-details.component.ts ***!
  \**********************************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PostsDetailsComponent", function() { return PostsDetailsComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _data_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../data.service */ "./src/app/data.service.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
...
var PostsDetailsComponent = /** @class */ (function () {
    function PostsDetailsComponent(route, data) {
        var _this = this;
        this.route = route;
        this.data = data;
        this.route.params.subscribe(function (params) { return _this.post = params.id; });
    }
    PostsDetailsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.data.getPost(this.post).subscribe(function (data) { return _this.post = data; });
    };
    PostsDetailsComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-posts-details',
            template: __webpack_require__(/*! ./posts-details.component.html */ "./src/app/posts-details/posts-details.component.html"),
            styles: [__webpack_require__(/*! ./posts-details.component.scss */ "./src/app/posts-details/posts-details.component.scss")]
        }),
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], _data_service__WEBPACK_IMPORTED_MODULE_1__["DataService"]])
...
module.exports = __webpack_require__(/*! C:\Users\Davor\Desktop\Angular 6\angular6\src\main.ts */"./src/main.ts");
